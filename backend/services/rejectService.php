<?php
  ...
  $mutate = "
    ...
    VALUES ($providerId, $id, 'Rejected Listing', '$providerProperty has been rejected.', 'Unread')
  ";

  /* Creating Notif [END] */

  /* Check if initial listing */

  $statement = $connect->prepare($mutate);
  $statement->execute();

  $query = "
    SELECT * FROM users_tbl WHERE id = $providerId
  ";
        ...
        <!DOCTYPE html>
          ...
          <body>
              <div class="email-container">
                  ...
                  <div class="content">
                      <p>Hi there,</p>
                      <p>We’re sorry to inform you that your <strong>'.$name.'</strong> service request has been <strong>rejected</strong>. Unfortunately, we are unable to approve it at this time.</p>
                      <p>If you believe this was a mistake or you\'d like to know more about the reason, you can visit your dashboard to review details or contact support.</p>
                  ...
                  <!-- Footer -->
                  <div class="footer">
                      <p>If you have any questions, feel free to reach out to our support team at <a href="mailto:support@easyvent.com">support@easyvent.com</a>.</p>
                  </div>
              </div>
          </body>
          </html>
