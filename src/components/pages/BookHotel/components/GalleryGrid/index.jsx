...
const GalleryGrid = ({ imagesUrl = []}) => {
  ...
  return (
    <>
      <div class="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-4 mb-8 h-[20rem]">
        <div onClick={() => setSelectedImage(0)} class="bg-blue-200 h-[20rem] rounded-xl shadow-md hover:shadow-2xl overflow-hidden cursor-pointer">
          <img src={images[0]} alt="" className="w-full h-full" />
        </div>

        <div class="hidden md:grid grid-rows-2 grid-cols-2 gap-2">
