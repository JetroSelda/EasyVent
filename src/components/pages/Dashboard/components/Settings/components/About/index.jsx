...
const AboutSettings = ({ settings = {}, refresh }) => {
  ...
  const handleSubmit = async () => {
    ...
    fetch(`${import.meta.env.VITE_API_URL}/settings/updateAbout.php`, {
      method: "POST",
      body: formData,
    })
      .then((res) => res.json())
    ...
    <Card>
      <CardContent>
        <div className="flex justify-between items-center mb-5">
          <div className="semi-bold">About Page</div>
        ...
        <div className="py-3 grid gap-2">
          <TextEditor disabled={isLoading || !enabledForm} defaultValue={currState.about} onChange={handleChange} />
        </div>
      </CardContent>
    </Card>
  )
